const INSTS = ['FVPP','ATASB','FAMCEEF','FOQS','ASAFAB','ASBAP','AEFAM','AEFAC'];
...
const DATA = {
  project: {
    name: 'Projeto Frutificar Amazônia',
    start: 'Abril/2026',
    end: 'Setembro/2029',
    months: 42,
    families: 723,
  ...
  institutions: [
    { id: 'fvpp', name: 'FVPP', full: 'Fundação Viver Produzir e Preservar', region: 'Transamazônica', state: 'PA',
      cities: ['Altamira', 'Anapu', 'Senador José Porfírio'], families: 120, progress: 8, activities: 12, planned: 16,
    ...
    { id: 'atasb', name: 'ATASB', full: 'Associação dos Trabalhadores Agroextrativistas do Setor Baquiá', region: 'Tapajós', state: 'PA',
      cities: ['Gurupá'], families: 95, progress: 6, activities: 8, planned: 12,
      ...
      metaBreakdown: { beneficiarios: 100, agroindustrias: 1, veiculos: 1, estudos: 2, eventos: 22, publicacoes: 0 } },
    { id: 'famceef', name: 'FAMCEEF', full: 'Federação das Associações de Moradores, Comunidades e Entidades do Assentamento Agroextrativista - Eixo Forte', region: 'Tapajós', state: 'PA',
      cities: ['Santarém'], families: 85, progress: 4, activities: 2, planned: 9,
      ...
      metaBreakdown: { beneficiarios: 100, agroindustrias: 1, veiculos: 1, estudos: 1, eventos: 21, publicacoes: 1 } },
    { id: 'foqs', name: 'FOQS', full: 'Federação das Organizações Quilombolas de Santarém', region: 'Tapajós', state: 'PA',
      cities: ['Santarém'], families: 78, progress: 7, activities: 7, planned: 9,
    ...
    { id: 'asafab', name: 'ASAFAB', full: 'Associação dos Agricultores Familiares da Batata', region: 'Tapajós', state: 'PA',
      cities: ['Placas'], families: 65, progress: 3, activities: 2, planned: 8,
      ...
      metaBreakdown: { beneficiarios: 80, agroindustrias: 1, veiculos: 2, estudos: 1, eventos: 10, publicacoes: 2 } },
    { id: 'aefam', name: 'AEFAM', full: 'Associação da Escola Família Agroecológica do Macacoari', region: 'Amapá', state: 'AP',
      cities: ['Macapá', 'Itaubal'], families: 110, progress: 5, activities: 4, planned: 10,
      ...
      metaBreakdown: { beneficiarios: 145, agroindustrias: 0, veiculos: 2, estudos: 0, eventos: 5, publicacoes: 1 } },
    { id: 'asbap', name: 'ASBAP', full: 'Associação dos Batedores e Produtores de Açaí do Estado do Amapá', region: 'Amapá', state: 'AP',
      cities: ['Macapá'], families: 90, progress: 4, activities: 4, planned: 5,
      ...
      metaBreakdown: { beneficiarios: 100, agroindustrias: 1, veiculos: 0, estudos: 0, eventos: 6, publicacoes: 7 } },
    { id: 'aefac', name: 'AEFAC', full: 'Associação da Escola Família Agroextrativista do Carvão', region: 'Amapá', state: 'AP',
      cities: ['Mazagão'], families: 80, progress: 2, activities: 0, planned: 6,
      ...
      metaBreakdown: { beneficiarios: 320, agroindustrias: 1, veiculos: 1, estudos: 3, eventos: 21, publicacoes: 5 } },
  ],
  ...
  activities: [
    { date: '10/06/2026', inst: 'FVPP', type: 'Visita técnica', status: 'done' },
    { date: '09/06/2026', inst: 'FOQS', type: 'Diagnóstico rural', status: 'done' },
    { date: '08/06/2026', inst: 'ATASB', type: 'Treinamento', status: 'done' },
    { date: '07/06/2026', inst: 'AEFAM', type: 'Visita técnica', status: 'inProgress' },
    { date: '06/06/2026', inst: 'FAMCEEF', type: 'Oficina participativa', status: 'done' },
    { date: '05/06/2026', inst: 'ASBAP', type: 'Diagnóstico rural', status: 'done' },
    { date: '04/06/2026', inst: 'ASAFAB', type: 'Treinamento', status: 'pending' },
    { date: '03/06/2026', inst: 'AEFAC', type: 'Visita técnica', status: 'pending' },
    { date: '02/06/2026', inst: 'FVPP', type: 'Oficina participativa', status: 'done' },
    { date: '01/06/2026', inst: 'FOQS', type: 'Treinamento', status: 'done' },
    { date: '30/05/2026', inst: 'ATASB', type: 'Diagnóstico rural', status: 'done' },
    { date: '28/05/2026', inst: 'AEFAM', type: 'Oficina participativa', status: 'done' },
    { date: '26/05/2026', inst: 'FAMCEEF', type: 'Visita técnica', status: 'inProgress' },
    { date: '24/05/2026', inst: 'ASBAP', type: 'Treinamento', status: 'done' },
    { date: '22/05/2026', inst: 'ASAFAB', type: 'Diagnóstico rural', status: 'done' },
  ],
...
DATA.estudos = (() => {
  const titulos = [
    ...
    { t: 'Plano de comunicação do Projeto Frutificar Amazônia', tipo: 'plano_comunicacao', cadeia: 'ambas' },
  ...
  return titulos.map((t, i) => ({
    ...
    tipo: t.tipo,
    cadeia: t.cadeia,
    instituicao: ['IPAM','FVPP','AEFAM','CEPLAC','EMBRAPA'][Math.floor(Math.random() * 5)],
